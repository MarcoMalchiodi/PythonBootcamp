...
// each variable is a different flower
var dataB1 = [1, 1, 0];
var dataB2 = [2, 1,   0];
var dataB3 = [2, .5, 0];
var dataB4 = [3,   1, 0];
...
var all_points = [dataB1, dataB2, dataB3, dataB4, dataR1, dataR2, dataR3, dataR4]; // all flowers
...
function train() {
  ...
  for (let iter = 0; iter < 50000; iter++) {
    // pick a random point / random flower
    ...
    let pred = sigmoid(z); // our Network's prediction
